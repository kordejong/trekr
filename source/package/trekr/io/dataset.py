...
#
#     def write(
#         self, time_point: datetime.datetime, variant: str, magnitude: float
#     ) -> None:
#         with sqlite3.connect(
#             record_path(self.path), detect_types=sqlite3.PARSE_DECLTYPES
#         ) as connection:
...
#                 )
#                 cursor.executemany(
#                     "INSERT INTO variants VALUES(:variant_id, :variant)", data
#                 )
#
#             results = cursor.execute("""
...
#
#             cursor.executemany(
#                 "INSERT INTO magnitudes VALUES(:magnitude_id, :time_point, :variant_id, :magnitude)",
#                 data,
#             )
#
